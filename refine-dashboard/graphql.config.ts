...
const config: IGraphQLConfig = {
    ...
    extensions: {
        ...
        codegen: {
            // hooks are commands that executed after a certain event
            hooks: {
            ...
            generates: {
                ...
                // we write in our code to fetch data from the GraphQL server
                "src/graphql/types.ts": {
                    ...
                    preset: "import-types",
                    // documents is used to define the path of the files that contains GraphQL operations
                    plugins: ["typescript-operations"],
                    config: {
                        skipTypename: true,
                        enumsAsTypes: true,
                        // determine whether the generated types should be resolved ahead of time or not
                        // when preResolveTypes is set to true, the code generator will not try to resolve the types ahead of time
