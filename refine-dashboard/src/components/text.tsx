...
// a custom Text compinent that wraps/extends the antd Typography.Text component
export const Text = ({size = "sm", children, ...rest}: TextProps) => {
    return (
        // config provider is a top-level compinent that allows us to
        // customize the global properties of antd components
        // for example, default antd theme
        // token is a term used by antd to refer to the design tokens
