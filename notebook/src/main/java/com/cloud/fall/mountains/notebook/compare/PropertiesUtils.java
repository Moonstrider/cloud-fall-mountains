...
//        String dragonPath = "/Users/xzhu54/work/global/lab/dragonite-gitops/app/internet/volvoid/account-api/overlays/cn.c3.qa/qa_patch.yaml";
//        String globalPath = "/Users/xzhu54/work/global/lab/identity-access-management-gitops/app/internet/volvoid/account-api/overlays/eu.qa.volvoc3.com/qa_patch.yaml";
        compareFileDiff(dragonPath, globalPath);
    }

    public static void compareFileDiff(String dragonFilePath, String globalFilePath) {
...
//                    System.out.println("Both sides have key:[" + key + "] value:[" + dragon.getProperty((String) key) + "]");
    ...
    public static Properties loadProperties(String yamlPath) {
        try {
            ...
            Iterable<Object> objects = yaml.loadAll(yamlPath);
            for (Object object : objects) {
                System.out.println(object);
            }

//            properties.putAll(getFlattenedMap(yaml.loadAll(yamlPath)));
